...
return new class extends Migration
{
    ...
    {
        Schema::create('x3d_chairs', function (Blueprint $table) {
            $table->id();
            $table->string('name');
            ...
            $table->longText('senderan_texture_filepath')->nullable();
    ...
    {
        Schema::dropIfExists('x3d_chairs');
    }
};
