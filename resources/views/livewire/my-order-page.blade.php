                        ...
                        <thead>
                            <tr>
                                ...
                                <th scope="col"
                                    ...
                                    Amount</th>
                                <th scope="col"
                                    class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase">Working
                                    Time</th> <!-- Kolom Baru -->
                                <th scope="col"
                            ...
                            @foreach ($orders as $order)
                                @php
                                    ...
                                    if ($order->status == 'completed') {
                                        $status =
                                            ' <span class="bg-green-600 py-1 px-3 rounded text-white shadow">Completed</span>';
                                    }
                                ...
                                <tr class="odd:bg-white even:bg-gray-100 dark:odd:bg-slate-900 dark:even:bg-slate-800"
                                    ...
                                    <!-- Kolom Working Time -->
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">
                                        {{ $order->working_time ? $order->working_time . ' ' : 'Not Set' }}
                                    </td>
