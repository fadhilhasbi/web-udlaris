<div
    class="mx-auto w-full flex-grow border-y border-gray-200 bg-gray-100 px-4 py-10 dark:border-gray-700 dark:bg-gray-700 sm:px-6 lg:px-8">
            ...
            <div class="mx-auto max-w-7xl px-4 py-4 md:px-6 lg:py-6">
                <div class="-mx-3 mb-24 flex flex-wrap">
                        ...
                        <div class="mb-5 border border-gray-200 bg-white p-4 dark:border-gray-900 dark:bg-gray-900">
                            ...
                            <div>
                                ...
                                <div class="flex justify-between">
                                    <span
                                        class="inline-block text-lg font-bold text-green-600">{{ Number::currency(1000, 'IDR') }}</span>
                                    <span
                                        class="inline-block text-lg font-bold text-green-600">{{ Number::currency(500000, 'IDR') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="w-full px-3 lg:w-3/4">
                        <div class="mb-4 px-3">
                            <div
                                class="hidden items-center justify-between bg-gray-100 px-3 py-2 dark:bg-gray-900 md:flex">
                                    ...
                                    <div class="border border-gray-300 dark:border-gray-700">
                                        <div class="relative bg-gray-200">
                                            ...
                                            @if ($product->in_stock <= 0)
                                                <div
                                                    class="absolute inset-0 flex items-center justify-center bg-red-500 bg-opacity-75 text-white font-bold">
                                        ...
                                        <div class="p-3">
                                            <div class="mb-2 flex items-center justify-between gap-2">
                                                <h3 class="text-xl font-medium dark:text-gray-400">{{ $product->name }}
                                                </h3>
                                            </div>
                                            <p class="text-lg">
                                                <span
                                        ...
                                        <div
                                            class="flex justify-center border-t border-gray-300 p-4 dark:border-gray-700">
                                            @if ($product->in_stock > 0)
                                                <a wire:click.prevent="addToCart({{ $product->id }})" href="#"
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                        height="16" fill="currentColor" class="bi bi-cart3 h-4 w-4"
                                                        viewBox="0 0 16 16">
                                                        <path
                                            ...
                                            @else
                                                ...
                                                {{-- @else
                                                <button class="text-red-500 font-bold btn btn-secondary" disabled>Out of Stock
                                                </button> --}}
                                            @endif
                                        </div>
                                    </div>
