            ...
            <div class="md:col-span-12 lg:col-span-8 col-span-12">
                ...
                <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
                    ...
                    <ul class="grid w-full gap-6 md:grid-cols-2">
                        <li>
                            <input wire:model="payment_method" class="hidden peer" id="payment_method1" type="radio"
                                value="cod" />
                            <label
                        ...
                        <li>
                            <input wire:model="payment_method" class="hidden peer" id="payment_method2" type="radio"
                                value="midtrans">
                            <label
                                class="inline-flex items-center justify-between w-full p-5 text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 dark:peer-checked:text-blue-500 peer-checked:border-blue-600 peer-checked:text-blue-600 hover:text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700"
                                for="payment_method2">
                            ...
                            <li class="py-3 sm:py-4" wire:key='{{ $items['product_id'] }}'>
                                <div class="flex items-center">
                                    <div class="flex-shrink-0">
                                        <img alt="{{ $items['name'] }}" class="w-12 h-12 rounded-full"
