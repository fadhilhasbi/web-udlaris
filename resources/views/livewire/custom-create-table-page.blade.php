    ...
    <section class="mt-8">
        ...
        <div class="m-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                @foreach ($x3d_table->model1_filepath as $item_model1_key => $item_model1)
                    <div class="card bg-white border rounded-lg shadow-md p-4 hover:shadow-lg cursor-pointer transition-transform transform-gpu hover:scale-105"
                        onclick="selectPart('{{ $item_model1 }}', 'model1', {{ $x3d_table->price1[$item_model1_key]['price1'] ?? 'null' }})"
                        ...
                        <div class="flex flex-col items-center">
                            ...
                            <div class="mt-2">
                                @foreach ($x3d_table->model1_originalname as $item_model1_name_key => $item_model1_name)
                                    @php
                                ...
                                <div>
                                    <div class="mt-4">
                                        ...
                                        <p>
                                            @if (is_array($x3d_table->price1) && isset($x3d_table->price1[$item_model1_key]))
                                                Rp{{ number_format($x3d_table->price1[$item_model1_key]['price1'], 0, ',', '.') }}
                                            @else
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                @foreach ($x3d_table->model2_filepath as $item_model2_key => $item_model2)
                    <div class="card bg-white border rounded-lg shadow-md p-4 hover:shadow-lg cursor-pointer transition-transform transform-gpu hover:scale-105"
                        onclick="selectPart('{{ $item_model2 }}', 'model2', {{ $x3d_table->price2[$item_model2_key]['price2'] ?? 'null' }})"
                        ...
                        <div class="flex flex-col items-center">
                            ...
                            <div class="mt-2">
                                @foreach ($x3d_table->model2_originalname as $item_model2_name_key => $item_model2_name)
                                    @php
                                ...
                                <div>
                                    <div class="mt-4">
                                        <h2 class="text-xl font-semibold">Harga:</h2>
                                        <p>
                                            @if (is_array($x3d_table->price2) && isset($x3d_table->price2[$item_model2_key]))
                                                Rp{{ number_format($x3d_table->price2[$item_model2_key]['price2'], 0, ',', '.') }}
                                            @else
                                                Harga tidak tersedia
                                            @endif
                                        </p>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                @foreach ($x3d_table->model3_filepath as $item_model3_key => $item_model3)
                    <div class="card bg-white border rounded-lg shadow-md p-4 hover:shadow-lg cursor-pointer transition-transform transform-gpu hover:scale-105"
                        onclick="selectPart('{{ $item_model3 }}', 'model3', {{ $x3d_table->price3[$item_model3_key]['price3'] ?? 'null' }})"
                        ...
                        <div class="flex flex-col items-center">
                            ...
                            <div class="mt-2">
                                @foreach ($x3d_table->model3_originalname as $item_model3_name_key => $item_model3_name)
                                    @php
                                ...
                                <div>
                                    <div class="mt-4">
                                        <h2 class="text-xl font-semibold">Harga:</h2>
                                        <p>
                                            @if (is_array($x3d_table->price3) && isset($x3d_table->price3[$item_model3_key]))
                                                Rp{{ number_format($x3d_table->price3[$item_model3_key]['price3'], 0, ',', '.') }}
                                            @else
                                                Harga tidak tersedia
                                            @endif
                                        </p>
        ...
        <div id="warningModal" class="fixed inset-0 flex justify-center items-center bg-gray-900 bg-opacity-75"
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg text-center">
                ...
                <button onclick="closeWarningModal()"
                    class="mt-4 bg-blue-600 text-white py-2 px-4 rounded">OK</button>
            </div>
        </div>
        ...
        <script>
            ...
            function addToCart() {
                ...
                var uniqueId = 'model' + 'table' + ((Math.floor(Math.random() * 99) + 1) * 100);
                var uniqueName = 'table-' + 'custom-' + ((Math.floor(Math.random() * 99) + 1) * 100);
