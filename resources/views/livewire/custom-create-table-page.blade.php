        ...
        <div class="m-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                @foreach ($x3d_table->model1_filepath as $item_model1_key => $item_model1)
                    <div class="card bg-white border rounded-lg shadow-md p-4 hover:shadow-lg cursor-pointer transition-transform transform-gpu hover:scale-105"
                        onclick="selectPart('{{ $item_model1 }}', 'model1', {{ $x3d_table->price1[$item_model1_key]['price1'] ?? 'null' }})" id="card_model1_{{ $item_model1_key }}">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                @foreach ($x3d_table->model2_filepath as $item_model2_key => $item_model2)
                    <div class="card bg-white border rounded-lg shadow-md p-4 hover:shadow-lg cursor-pointer transition-transform transform-gpu hover:scale-105"
                        onclick="selectPart('{{ $item_model2 }}', 'model2', {{ $x3d_table->price2[$item_model2_key]['price2'] ?? 'null' }})" id="card_model2_{{ $item_model2_key }}">
                        <div class="flex flex-col items-center">
                            <x3d width="100px" height="100px">
                                <scene>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                @foreach ($x3d_table->model3_filepath as $item_model3_key => $item_model3)
                    <div class="card bg-white border rounded-lg shadow-md p-4 hover:shadow-lg cursor-pointer transition-transform transform-gpu hover:scale-105"
                        onclick="selectPart('{{ $item_model3 }}', 'model3', {{ $x3d_table->price3[$item_model3_key]['price3'] ?? 'null' }})" id="card_model3_{{ $item_model3_key }}">
                        <div class="flex flex-col items-center">
                            <x3d width="100px" height="100px">
                                <scene>
